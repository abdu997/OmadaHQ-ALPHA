...
$sql = "SELECT record_id, type, user_id, name, start_message, start_time, end_time, expected_time, optimistic_time, realistic_time, pessimistic_time, task_id, goal_id, color, progress, timestamp FROM pert_table WHERE team_id = '$team_id' AND (type = 'task' OR type = 'sub_task') AND status = 'valid'";
